...
public class Main 
{
    public static void main (String[] args)
    {
        ...
        Equation e = new QuadEquation(a, b, c); // here're working both of logical blocks (static and non-static from class Equation)
        
        e.solve();        
        //e.print();
        System.out.println(e); // here will be printed the string which returns the overriden method toString() (basic method of class Object)
